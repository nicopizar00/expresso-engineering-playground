...
- The `/visualizer` page embeds the iframe at **`/viz/index.html`** (not the
  ...
  would make the visualizer's *relative* asset paths resolve to `/scene.js`.
...
- Wiring constraints: [../project-state/frontend-wiring-status.md](../project-state/frontend-wiring-status.md)
