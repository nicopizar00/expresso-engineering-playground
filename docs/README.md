...
| [adr/README.md](adr/README.md)                                             | Architecture Decision Records — _why_ we got here                                  |
...
- "Current state" docs (`project-state/`, `architecture/`) describe what _is_;
  ADRs describe _why_. When a decision changes, update both.
