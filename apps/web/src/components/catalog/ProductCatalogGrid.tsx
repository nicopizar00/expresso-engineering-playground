...
export function ProductCatalogGrid({ products }: ProductCatalogGridProps) {
  ...
  return (
    <div>
      {/* Filter tabs */}
      <div
        className="flex items-center gap-1 mb-4 p-0.5 rounded-md overflow-x-auto"
        ...
        {categoryFilters.map(({ value, label, icon: Icon }) => {
          ...
          return (
            <button
              ...
              className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded text-xs font-medium whitespace-nowrap transition-all duration-150 min-h-[30px]"
              style={{
            ...
            >
              ...
              <span>{label}</span>
              <span
                className="px-1 py-0 text-[10px] font-medium rounded-full leading-none"
                style={{
