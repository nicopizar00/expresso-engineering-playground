 ...
 * Once a cup is selected, the only normal product action is Place Order
 * (CUP-001) — quantity and removal controls are not shown because the BFF
 * now rejects both once an item is in the cart.
 */
...
/**
 * Cart item row for full cart page. Once a cup is selected, the only normal
 * product action is Place Order (CUP-001) — quantity and removal controls
 * are not shown because the BFF now rejects both once an item is in the cart.
 */
    ...
    <div className="p-4 sm:p-6">
      <div className="flex gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-sm mt-3 font-medium" style={{ color: 'var(--foreground)' }}>
            Qty: {item.quantity}
          </p>
        </div>
